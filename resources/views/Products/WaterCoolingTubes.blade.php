    ...
    @foreach($products as $product)
        ...
        <div class="card" style="max-width: 22rem">
            ...
            <div class="card-body">
                ...
                <h4 class="card-title font-weight-bold text-capitalize">{{ $product->Brand . " " }}<a href="/category/Water-Cooler-Tube/{{ $product->id }}">{{ $product->Product_Name }}</a></h4>

                <ul class="list-inline">
                    <li class="list-inline-item">&bull; Length {{ $product->Length }}mm</li>
                    <li class="list-inline-item">&bull; Width {{ $product->Size }}mm</li>
                </ul>
