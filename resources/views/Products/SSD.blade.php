    ...
    @foreach($products as $product)
        ...
        <div class="card" style="max-width: 22rem">
            ...
            <div class="card-body">
                ...
                <h4 class="card-title font-weight-bold text-capitalize">{{ $product->Brand . " " }}<a href="/category/SSD/{{ $product->id }}">{{ $product->Product_Name }}</a></h4>

                <ul class="list-inline">
                    <li class="list-inline-item">&bull; @if($product->Storage < 1000) {{ $product->Storage }} GB @else {{ $product->Storage/1000 }} TB @endif</li>
                    <li class="list-inline-item">&bull; {{ $product->Speed }}Gb/s</li>
                    <li class="list-inline-item">&bull; {{ $product->Write_Speed }}Gb/s</li>
                    <li class="list-inline-item">&bull; {{ $product->Read_Speed }}Gb/s</li>
                    <li class="list-inline-item">&bull; {{ $product->Connector_Type }}</li>
