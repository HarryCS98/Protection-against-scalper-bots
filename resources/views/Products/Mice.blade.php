    ...
    @foreach($products as $product)
        ...
        <div class="card" style="max-width: 22rem">
            ...
            <div class="card-body">
                ...
                <h4 class="card-title font-weight-bold text-capitalize">{{ $product->Brand . " " }}<a href="/category/Mice/{{ $product->id }}">{{ $product->Product_Name }}</a></h4>

                <ul class="list-inline">
                    <li class="list-inline-item">&bull; {{ $product->Sensor }} Sensor</li>
                    <li class="list-inline-item">&bull; {{ $product->Max_DPI }} Max DPI</li>
                    <li class="list-inline-item">&bull; {{ $product->Min_DPI }} Min DPI</li>
                    <li class="list-inline-item">&bull; Wireless @if($product->Wireless == 1)  True @else False @endif</li>
                </ul>
