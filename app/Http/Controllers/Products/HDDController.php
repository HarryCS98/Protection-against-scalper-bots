...
class HDDController extends Controller
{
    ...
    {
        $products = HDD::all();
        return view('Products.HDD',['products'=>$products]);
    }


    public function show($id){
        $product = HDD::query()->find($id);
        return view('Products.HDD_item',['product'=>$product]);
    }
    ...
    public function addtobasket(Request $res){
        ...
        $Product = HDD::query()->find($res->Product_id);
