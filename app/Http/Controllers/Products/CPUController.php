...
class CPUController extends Controller
{
    ...
    {
        $products = CPU::all();
        return view('Products.CPU',['products'=>$products]);
    }


    public function show($id){
        $product = CPU::query()->find($id);
        return view('Products.CPU_item',['product'=>$product]);
    }
    ...
    public function addtobasket(Request $res){
        ...
        $Product = CPU::query()->find($res->Product_id);
