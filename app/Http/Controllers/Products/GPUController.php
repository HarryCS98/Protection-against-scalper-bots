...
class GPUController extends Controller
{
    ...
    {
        $products = GPU::all();
        return view('Products.GPU',['products'=>$products]);
    }


    public function show($id){
        $product = GPU::query()->find($id);
        return view('Products.GPU_item',['product'=>$product]);
    }
    ...
    public function addtobasket(Request $res){
        ...
        $Product = GPU::query()->find($res->Product_id);
