...
class MotherboardController extends Controller
{
    ...
    {
        $products = Motherboard::all();
        return view('Products.MotherBoards',['products'=>$products]);
    }


    public function show($id){
        $product = Motherboard::query()->find($id);
        return view('Products.MotherBoard_item',['product'=>$product]);
    }
    ...
    public function addtobasket(Request $res){
        ...
        $Product = Motherboard::query()->find($res->Product_id);
