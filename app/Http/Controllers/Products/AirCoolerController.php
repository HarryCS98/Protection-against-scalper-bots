...
class AirCoolerController extends Controller
{
    ...
    {
        $products = AirCooler::all();
        return view('Products.AirCoolers',['products'=>$products]);
    }


    public function show($id){
        $product = AirCooler::query()->find($id);
        return view('Products.AirCooler_item',['product'=>$product]);
    }
    ...
    public function addtobasket(Request $res){
        ...
        $Product = AirCooler::query()->find($res->Product_id);
