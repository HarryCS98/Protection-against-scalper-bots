...
use App\Models\Products\Keyboard;
...
class KeyboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Products.Keyboards',['products'=>$products]);
    }


    public function show($id){
        $product = Keyboard::query()->find($id);
        return view('Products.Keyboard_item',['product'=>$product]);
    }
    ...
    public function addtobasket(Request $res){
        ...
        $Product = Keyboard::query()->find($res->Product_id);
