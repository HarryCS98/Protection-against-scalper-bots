...
use App\Models\Products\WaterCoolerTube;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;

class WaterCoolerTubeController extends Controller
{
    public function index()
    {
        $products = WaterCoolerTube::all();
        return view('Products.WaterCoolingTubes',['products'=>$products]);
    }


    public function show($id){
        $product = WaterCoolerTube::query()->find($id);
        return view('Products.WaterCoolingTube_item',['product'=>$product]);
    }
    ...
    public function addtobasket(Request $res){
        ...
        $Product = WaterCoolerTube::query()->find($res->Product_id);
