...
class MiceController extends Controller
{
    ...
    {
        $products = Mice::all();
        return view('Products.Mice',['products'=>$products]);
    }

    public function show($id){
        $product = Mice::query()->find($id);
        return view('Products.Mice_item',['product'=>$product]);
    }
    ...
    public function addtobasket(Request $res){
        ...
        $Product = Mice::query()->find($res->Product_id);
