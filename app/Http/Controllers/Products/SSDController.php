...
class SSDController extends Controller
{
    ...
    {
        $products = SSD::all();
        return view('Products.SSD',['products'=>$products]);
    }


    public function show($id){
        $product = SSD::query()->find($id);
        return view('Products.SSD_item',['product'=>$product]);
    }
    ...
    public function addtobasket(Request $res){
        ...
        $Product = SSD::query()->find($res->Product_id);
