    ...
    <mousemovementlogging></mousemovementlogging>
        ...
        <div class="row">
            ...
            <div class="col-3">
                ...
                <div class="row">
                    <a href="#">
                        <img class="img-fluid overflow-hidden" src="<?php echo e(asset('img/advert.png')); ?>">
                    </a>
                </div>
            </div>
                ...
                <div class="row pt-3">
                    ...
                    <div class="col">
                        <div class="media" style="color: white">
                            <img class="mr-3" src="<?php echo e(asset('img/pc_case.png')); ?>" alt="Generic placeholder image">
            ...
            <div class="col-3">
                <div class="row">
                    <a href="#">
                        <img class="img-fluid overflow-hidden" src="<?php echo e(asset('img/advert2.png')); ?>">
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dissertation\resources\views/welcome.blade.php ENDPATH**/ ?>